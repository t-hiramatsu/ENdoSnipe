...
/**
 * DataCollectorからの設定取得応答を受け、クライアントに設定情報を返すためのリスナです。
 * 
 * @author hiramatsu
 */
public class ControlGetPropertyListener extends AbstractTelegramListener
{
    /** ロガー */
     ...
     * デフォルトコンストラクタ
     */
    public ControlGetPropertyListener()
    {
    ...
    {
        return TelegramConstants.BYTE_TELEGRAM_KIND_GET_PROPERTY;
    }
