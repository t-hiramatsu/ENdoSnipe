function raphaelDashboardMoveCommand(targetList, argument) {
	this.targetList = targetList;
	this.argument = argument;
};
raphaelDashboardMoveCommand.prototype = new command();

raphaelDashboardMoveCommand.prototype.execute = function() {
