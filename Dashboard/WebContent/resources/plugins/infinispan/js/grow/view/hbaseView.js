...
//                       Class                         //
/////////////////////////////////////////////////////////
infinispan.HbaseView = wgp.AbstractView
		.extend({
			...
			_getTermData : function() {
				...
				this.dygraphAttributes = infinispan.hbase.graph.attributes;
				var instance = this;
			...
			render : function() {
				...
				this
						._setAnnotationLegend(infinispan.hbase.parent.id.annotationLegendArea);
			...
			_getAnnotationElement : function(timestamp, eventList, series) {
				...
				var eventTypeDict = infinispan.hbase.graph.eventType;
				...
				// css
				annotationElement.cssClass = infinispan.hbase.graph.annotation.shortTextClassName
						+ ' '
						+ eventClassName
						+ ' '
						+ infinispan.hbase.graph.annotation.xValueClassNamePrefix
						+ timestamp;
			...
			_setAnnotationLegend : function(targetId) {
				// initialize the area
				// var targetId =
				// infinispan.hbase.parent.id.annotationLegendArea;
				$('#' + targetId).empty();

				// add legend of all events
				var eventTypeDict = infinispan.hbase.graph.eventType;
				var annotationShortTextClassName = infinispan.hbase.graph.annotation.shortTextClassName;
			...
			_setAnnotationCss : function() {
				var shortTextClassName = infinispan.hbase.graph.annotation.shortTextClassName;
			...
			_hilightedActionForAnnotation : function(x) {
				var className = infinispan.hbase.graph.annotation.xValueClassNamePrefix
						+ x;
