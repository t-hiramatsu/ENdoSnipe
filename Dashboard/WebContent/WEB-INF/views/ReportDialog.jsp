...
<body>
	...
	<div id="reportDialog" title="Output Report" style="display:none">
		<div id="reportNameArea" class="dialogContentArea" style="display:none">
		...
		<div id="reportNameArea" class="dialogContentArea">
			...
			<div id="reportNameValue" class="dialogValue">
				<input type="text" id="reportName" class="reportValue" value="new report" />
			</div>
		</div>
		<div id="reportTargetNameArea" class="dialogContentArea">
			<div id="reportTargetNameItem" class="dialogItem">Target Measurement Name : </div>
			<div id="reportTargetNameValue" class="dialogValue">
				<input type="text" id="targetName" class="reportValue" value="" readonly="readonly" />
			</div>
		</div>
		<div id="reportSetTermArea" class="dialogContentArea">
			...
			<div id="reportSetTermValue" class="dialogValue">
				From : <input name="jquery-ui-datepicker-from" class="hasDatepicker" id="jquery-ui-datepicker-from" type="text"/>
				To　　: <input name="jquery-ui-datepicker-to" class="hasDatepicker" id="jquery-ui-datepicker-to" type="text"/>
			</div>
		</div>
